  ...
  const handleDownload = (type: 'pdf' | 'docx') => {
    ...
    fetch(url, { headers: getAuthHeaders() })
      ...
      .then((blob) => {
        ...
        a.href = blobUrl;
        a.download = `IGNOU_${project?.courseCode || 'Project'}_${project?.enrollmentNumber || 'Draft'}.${type}`;
                ...
                {project?.status === 'READY' ? (
                  <>
                    <button
                      ...
                      className="w-full sm:flex-1 py-3 px-4 rounded-xl bg-blue-600 text-white font-bold text-sm hover:bg-blue-700 shadow-md flex items-center justify-center gap-2 transition"
                    >
                    ...
                    <button
                      ...
                      className="w-full sm:flex-1 py-3 px-4 rounded-xl bg-slate-800 text-white dark:bg-slate-700 font-bold text-sm hover:bg-slate-900 shadow-md flex items-center justify-center gap-2 transition"
                    >
